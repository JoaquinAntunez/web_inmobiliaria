...
# funcion para tener imagen en el slider
    ...
    img_uri = img_as_data_uri("img/texto8.png")
    img_uri2 = img_as_data_uri("img/Texto6.png")
    img_uri3 = img_as_data_uri("img/Texto7.png")
    ...
    with st.container():
        ...
        with col1:
            st.image("img/Texto4.png", width='content')
    ...
    with st.container():
        col1, col2 = st.columns(2, gap="large", border=True)
        with col1:
            st.image("img/Texto5.png", width='content')
    ...
    with st.container(border=True, horizontal=True, horizontal_alignment="center"):
        st.subheader('Convierte tus datos en ventaja competitiva.', text_alignment="center")
    st.divider()
